        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h2 class="subheader-title text-dark font-weight-bold my-1 mr-3">Categorías</h2>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="/categories/create" class="btn btn-fixed-height btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pr-0 text-right">
                                        ...
                                        <a href="/categories/delete/{{$category->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                            <span class="svg-icon svg-icon-md svg-icon-primary">
