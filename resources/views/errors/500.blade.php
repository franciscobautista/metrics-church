...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="/app/assets/css/pages/error/error-6.css?v=7.0.5" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-static page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(/app/assets/images/bg6.jpg);">
				<!--begin::Content-->
				<div class="d-flex flex-column flex-row-fluid text-center">
					<h1 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem;">Oops...</h1>
					<p class="display-4 font-weight-bold text-white">Parece que algo salió mal, contacta a soporte para poder resolver el error.</p>
				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->
