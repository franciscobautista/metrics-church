...
<html lang="en" ng-app="app">
	...
	<head>
		...
		<link href="/app/assets/css/pages/login/login-5.css" rel="stylesheet" type="text/css" />
        ...
        <script src="/app/assets/js/angular/controllers_landing.js?v={{strtotime(\Carbon\Carbon::now())}}"></script>
        <script src="/app/assets/js/angular/services_landing.js?v={{strtotime(\Carbon\Carbon::now())}}"></script>
	...
	<body class="kt-page--loading-enabled kt-page--loading kt-header--fixed kt-header--minimize-topbar kt-header-mobile--fixed kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-subheader--enabled kt-subheader--transparent kt-page--loading">
		...
		<!--<script src="/app/assets/js/pages/custom/login/login-general.js" type="text/javascript"></script> -->
