			...
			<div class="d-none d-lg-flex align-items-center mr-3">
				...
				<ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
					...
					<li class="nav-item mr-3">
						<a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Gráficas</a>
					</li>
					<!--end::Item-->
					<!--begin::Item-->
					<li class="nav-item mr-3">
						<a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Reportes</a>
					</li>
					<!--end::Item-->
					<!--begin::Item-->
					<li class="nav-item mr-3">
						<a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Registros</a>
					</li>
					<!--end::Item-->
				</ul>
				<!--begin::Tab Navs-->
		...
		<div class="container">
			...
			<div class="header-navs header-navs-left" id="kt_header_navs">
				...
				<ul class="header-tabs p-5 p-lg-0 d-flex d-lg-none nav nav-bold nav-tabs" role="tablist">
					...
					<!--begin::Item-->
					<li class="nav-item mr-2">
						<a href="#" class="nav-link btn btn-clean" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Help CeterXX</a>
					</li>
					<!--end::Item-->
				</ul>
				<!--begin::Tab Navs-->
