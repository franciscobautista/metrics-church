    ...
    <div class="d-flex flex-column-fluid">
		...
		<div class="container">
			...
			<div class="d-flex flex-row">
					...
					<div class="card card-custom card-stretch">
						...
						<div class="card-body pt-4">
							...
							<div class="navi navi-bold navi-hover navi-active navi-link-rounded" style="margin-top: 20px">
								...
								<div class="navi-item mb-2">
									<a href="/settings/services" class="navi-link py-4  @if($section == 'services') active @endif ">
										<span class="navi-icon mr-2">
											<span class="svg-icon">
										...
										<span class="navi-text font-size-lg">Servicios</span>
									</a>
								</div>
								...
								<div class="navi-item mb-2">
									<a href="/settings/service_times" class="navi-link py-4  @if($section == 'service_times') active @endif ">
										...
										<span class="navi-text font-size-lg">Tiempos de servicio</span>
									</a>
								</div>
				...
				<div class="flex-row-fluid ml-lg-8 d-block" id="kt_inbox_list" ng-controller="categoriasController">
					...
					<div class="card card-custom card-stretch">
						...
						<div class="card-body">
							...
							<a href="/subcategories/create" class="btn btn-primary mr-3"> <i class="flaticon-file"></i>Crear categoría</a>
							<a href="/categories/create" class="btn btn-outline-primary mr-3"> <i class="flaticon-file"></i>Crear categoría padre</a>
		                    <!--begin::Table-->
		                            ...
		                            <tbody>
		                                ...
		                                <tr style="background-color: #EBEDF3">
		                                    ...
		                                    <td class="pr-0 text-right">
		                                        ...
		                                        <a href="#" ng-click="deleteCategory({{$category->id}})" class="btn btn-icon btn-light btn-hover-primary btn-sm">
		                                            <span class="svg-icon svg-icon-md svg-icon-primary">
		                                ...
		                                <tr>
		                                    ...
		                                    <td class="pr-0 text-right">
		                                        <a href="/subcategories/edit/{{$subcategory->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
		                                            <span class="svg-icon svg-icon-md svg-icon-primary">
		                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg-->
		                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
		                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
		                                        ...
		                                        <a href="#" ng-click="deleteSubcategory({{$subcategory->id}})" class="btn btn-icon btn-light btn-hover-primary btn-sm">
		                                            <span class="svg-icon svg-icon-md svg-icon-primary">
		                                                <!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
		                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
		                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
		                                ...
		                                <tr>
		                                    <td>
		                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$subcategory->name}}</span>
		                                    </td>
		                                    <td class="pr-0 text-right">
		                                        <a href="/subcategories/edit/{{$subcategory->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
		                                            <span class="svg-icon svg-icon-md svg-icon-primary">
				...
				@if($section == 'service_times')
				<!--begin::Content-->
				<div class="flex-row-fluid ml-lg-8" id="kt_inbox_list" ng-controller="ServiceTimesController">
					<!--begin::Card-->
					<div class="card card-custom">
						<!--begin::Header-->
						<div class="card-header py-3">
							<div class="card-title align-items-start flex-column">
								<h3 class="card-label font-weight-bolder text-dark">Tiempos de servicio</h3> 
							</div>
						</div>
						<!--end::Header-->
						<div class="card-body">
						<a href="/servicetimes/create" class="btn btn-primary mr-3"> <i class="flaticon-file"></i>Crear</a>
						   <!--begin::Table-->
						   <div class="table-responsive">
							<table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
								<thead>
									<tr class="text-uppercase">
										...
										<th style="min-width: 120px">Organización</th>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->day}}</span>
										</td>
										<td>
											<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->hour}}</span>
										</td>
										<td>
											<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->service_type->name}}</span>
										</td>
										<td>
											<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->organization->name}}</span>
										</td>
										<td class=" ">
											<a href="/servicetimes/edit/{{$service->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
												<span class="svg-icon svg-icon-md svg-icon-primary">
													<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											<a href="#" ng-click="deleteServicioTimes({{$service->id}})" class="btn btn-icon btn-light btn-hover-primary btn-sm">
												<span class="svg-icon svg-icon-md svg-icon-primary">
													<!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
				...
				@if($section == 'services')
				<!--begin::Content-->
				<div class="flex-row-fluid ml-lg-8" id="kt_inbox_list" ng-controller="ServiceTypesController">
					<!--begin::Card-->
					<div class="card card-custom">
						<!--begin::Header-->
						<div class="card-header py-3">
							<div class="card-title align-items-start flex-column">
								<h3 class="card-label font-weight-bolder text-dark">Servicios</h3> 
							</div>
						</div>
						<!--end::Header-->
						<div class="card-body">
						<a href="/servicetypes/create" class="btn btn-primary mr-3"> <i class="flaticon-file"></i>Crear</a>
						   <!--begin::Table-->
						   <div class="table-responsive">
							<table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
								<thead>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->description}}</span>
										</td> 
										<td>
											<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->organization->name}}</span>
										</td>
										<td class=" ">
											<a href="/servicetypes/edit/{{$service->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
												<span class="svg-icon svg-icon-md svg-icon-primary">
													<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											<a href="#" ng-click="deleteServicioTypes({{$service->id}})" class="btn btn-icon btn-light btn-hover-primary btn-sm">
												<span class="svg-icon svg-icon-md svg-icon-primary">
													<!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
