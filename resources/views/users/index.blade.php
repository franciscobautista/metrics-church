                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0 text-right">
                                                ...
                                                <a href="/users/edit/{{$item->user->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                                ...
                                                <a href="/users/delete/{{$item->user->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                                    <span class="svg-icon svg-icon-md svg-icon-primary">
